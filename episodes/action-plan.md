...
| ACTION PLAN | Your Project Title:                                                                                  | Promoting Your Project                                                                                                                                                        |
| ----------- | ---------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
|             |                                                                                                      | - Utilizar task list like - [ ] an unchecked task list item FOUND HERE https://pandoc.org/MANUAL.html#extension-pipe_tables                                                   |
|             |                                                                                                      | - Wikipedia entry                                                                                                                                                             |
...
|             |                                                                                                      | - Disseminate information about your project via Listservs of professional organizations                                                                                      |
|             |                                                                                                      | Some ideas (delete these as you go):                                                                                                                                          |
|             |                                                                                                      | Think of both subject-related and library/archive related organizations.                                                                                                      |
|             | Build an effective social media strategy                                                             | Some ideas (delete these as you go):                                                                                                                                          |
...
|             | Some ideas (delete these as you go):                                                                 | Consider aspects such as:                                                                                                                                                     |
|             |                                                                                                      | - Best day and time to post your content                                                                                                                                      |
|             |                                                                                                      | - Visitor metrics                                                                                                                                                             |
|             |                                                                                                      | - Type of content with more views and reactions                                                                                                                               |
|             |                                                                                                      | - Use effective prompts for various types of analysis such as comparing your project with similar projects.                                                                   |
|             | Apply for awards and grants                                                                          | Some ideas (delete these as you go):                                                                                                                                          |
|             |                                                                                                      | - Find information about them in specialized databases                                                                                                                        |
|             |                                                                                                      | - Think of organizations that might support projects like yours (national agencies, professional organizations, etc.)                                                         |
|             | Encouraging Participation and Collaboration                                                          | Organize an edit-a-thon                                                                                                                                                       |
|             |                                                                                                      | Some ideas (delete these as you go):                                                                                                                                          |
|             |                                                                                                      | - Define its focus: topic, tasks, language, etc.                                                                                                                              |
|             |                                                                                                      | - Type of event: online, in-person, hybrid?                                                                                                                                   |
|             |                                                                                                      | - How would you organize it so that it could contribute to community building and potential future collaborations?                                                            |
|             | Participate in conference presentations and create events such as webinars, lectures, etc.           | Some ideas (delete these as you go):                                                                                                                                          |
|             |                                                                                                      | - Conference presentations, roundtables, academic posters, etc.                                                                                                               |
|             |                                                                                                      | - Webinars, lectures                                                                                                                                                          |
|             |                                                                                                      | - Events for highly targeted groups                                                                                                                                           |
|             | Choose and apply research methods to meet any specific goals you might have for your project.        | Some ideas (delete these as you go):                                                                                                                                          |
|             |                                                                                                      | - Focus groups                                                                                                                                                                |
|             |                                                                                                      | - Surveys, questionnaires                                                                                                                                                     |
|             |                                                                                                      | - Interviews                                                                                                                                                                  |
|             | Explore potential collaborations to provide a national and international dimension for your project. | Some ideas (delete these as you go):                                                                                                                                          |
...
|             | Design experiential learning opportunities                                                           | Some ideas (delete these as you go):                                                                                                                                          |
